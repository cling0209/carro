                    ...
                    <div class="card shadow-sm h-100">
                        ...
                        <div class="card-body">
                            ...
                            <div class="d-flex flex-wrap gap-2">
                                ...
                                <a href="{{ route('admin.products.import.template.excel') }}" class="btn btn-outline-primary" data-no-loader>
...
const BACKGROUND_IMPORT_ENABLED = @json((bool) config('products.import.background', true));
const chunkUploadUrl = @json(route('admin.products.import.chunk', [], false));
const initializeImportUrl = @json(route('admin.products.import.initialize', [], false));
const prepareTemplateImportUrl = @json(route('admin.products.import.prepare.template', [], false));
const processImportUrl = @json(route('admin.products.import.process', [], false));
const startBackgroundImportUrl = @json(route('admin.products.import.background', [], false));
const importProgressUrl = @json(route('admin.products.import.progress', [], false));
const previewImportUrl = @json(route('admin.products.import.preview', [], false));
const prepareImportUrl = @json(route('admin.products.import.prepare', [], false));
const importStatusUrl = @json(route('admin.products.import.status', [], false));
const unlockImportUrl = @json(route('admin.products.import.unlock', [], false));
