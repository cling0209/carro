...
class ProductImageProcessorTest extends TestCase
{
    ...
    public function test_build_filename_siempre_jpg(): void
    {
        $storage = app(\App\Services\ProductImageStorageService::class);

        $this->assertSame('ABC-123.jpg', $storage->buildFilename('ABC-123'));
        $this->assertSame('sku_1.jpg', $storage->buildFilename('sku 1'));
    }
}
