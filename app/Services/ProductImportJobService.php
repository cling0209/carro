...
{
    public const ROWS_PER_BATCH = 40;
     ...
     *     total_batches: int,
     *     result: array{created: int, updated: int, reactivated: int, skipped: int, errors: list<string>}
     * }
     */
    public function processNextBatch(string $uploadId, int $userId): array
    {
        ...
        $batchResult = app(ProductImportService::class)->importFromUploadedFile($uploaded);
    ...
    /**
     * @param  array{created: int, updated: int, reactivated: int, skipped: int, errors: list<string>}  $current
     * @param  array{created: int, updated: int, reactivated: int, skipped: int, errors: list<string>}  $batch
    ...
    protected function mergeResults(array $current, array $batch): array
    {
        return [
            ...
            'reactivated' => $current['reactivated'] + $batch['reactivated'],
